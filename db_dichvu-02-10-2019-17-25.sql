...
BEGIN
            DECLARE _start int(11);
						...
						SELECT pc.* FROM (SELECT idproduct from catehasproduct WHERE idcategory = _idcategory) as pc LEFT JOIN products as p on p.idproduct = pc.idproduct;
