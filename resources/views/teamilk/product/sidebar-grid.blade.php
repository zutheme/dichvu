<!-- BEGIN: LAYOUT/SIDEBARS/SHOP-SIDEBAR-MENU -->
	...
	<div class="c-padding-20 c-margin-t-40 c-bg-grey-1 c-bg-img-bottom-right" style="background-image:url({{ asset('assets-tea/assets/base/img/content/misc/feedback_box_2.png')}})">
