...
CREATE TABLE `cross_product`  (
  ...
  CONSTRAINT `fr_crossproduct` FOREIGN KEY (`idproduct_cross`) REFERENCES `products` (`idproduct`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fr_crosstype` FOREIGN KEY (`idcrosstype`) REFERENCES `cross_type` (`idcrosstype`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fr_product` FOREIGN KEY (`idproduct`) REFERENCES `products` (`idproduct`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `cross_type`  (
  `idcrosstype` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
INSERT INTO `exp_products` VALUES (49, 49, 1, 0, 12, 0, 0, 0, 0, 'dfgdg', 11, 0, 0, 0, 0, '2019-08-31 15:11:19', '2019-08-31 15:11:19');
INSERT INTO `exp_products` VALUES (50, 49, 2, 1, 12, 0, 0, 10, 1800000, '', 11, 0, 0, 0, 0, '2019-08-31 15:11:19', '2019-08-31 15:11:19');
INSERT INTO `exp_products` VALUES (51, 49, 4, 1, 12, 0, 0, 15, 2400000, '', 11, 0, 0, 0, 0, '2019-08-31 15:11:19', '2019-08-31 15:11:19');
INSERT INTO `exp_products` VALUES (52, 49, 5, 1, 12, 0, 0, 5, 9600000, '', 11, 0, 0, 0, 0, '2019-08-31 15:11:19', '2019-08-31 15:11:19');
INSERT INTO `exp_products` VALUES (53, 49, 6, 1, 12, 0, 0, 24, 2000000, '', 11, 0, 0, 0, 0, '2019-08-31 15:11:19', '2019-08-31 15:11:19');
INSERT INTO `exp_products` VALUES (54, 49, 7, 1, 12, 0, 0, 72, 800000, '', 11, 0, 0, 0, 0, '2019-08-31 15:11:19', '2019-08-31 15:11:19');
...
INSERT INTO `exp_products` VALUES (61, 61, 1, 0, 14, 0, 0, 1, 0, 'fgf', 11, 0, 0, 0, 0, '2019-09-07 13:37:54', '2019-09-07 13:37:54');
INSERT INTO `exp_products` VALUES (62, 61, 2, 0, 14, 0, 0, 12, 1800000, 'fgf', 11, 0, 0, 0, 0, '2019-09-07 13:37:54', '2019-09-07 13:37:54');
INSERT INTO `exp_products` VALUES (63, 61, 4, 0, 14, 0, 0, 15, 2400000, 'fgf', 11, 0, 0, 0, 0, '2019-09-07 13:37:54', '2019-09-07 13:37:54');
INSERT INTO `exp_products` VALUES (64, 61, 5, 0, 14, 0, 0, 5, 9600000, 'fgf', 11, 0, 0, 0, 0, '2019-09-07 13:37:54', '2019-09-07 13:37:54');
INSERT INTO `exp_products` VALUES (65, 61, 6, 0, 14, 0, 0, 26, 2000000, 'fgf', 11, 0, 0, 0, 0, '2019-09-07 13:37:54', '2019-09-07 13:37:54');
INSERT INTO `exp_products` VALUES (66, 61, 7, 0, 14, 0, 0, 70, 800000, 'fgf', 11, 0, 0, 0, 0, '2019-09-07 13:37:55', '2019-09-07 13:37:55');
INSERT INTO `exp_products` VALUES (67, 67, 12, 0, 15, 0, 0, 1, 0, 'fddf', 11, 0, 0, 0, 0, '2019-09-07 13:44:42', '2019-09-07 13:44:42');
INSERT INTO `exp_products` VALUES (68, 67, 13, 1, 15, 0, 0, 10, 2400000, '', 11, 0, 0, 0, 0, '2019-09-07 13:44:42', '2019-09-07 13:44:42');
INSERT INTO `exp_products` VALUES (69, 67, 14, 1, 15, 0, 0, 3, 9000000, '', 11, 0, 0, 0, 0, '2019-09-07 13:44:42', '2019-09-07 13:44:42');
...
CREATE TABLE `imp_products`  (
  ...
  CONSTRAINT `fr_imp_product` FOREIGN KEY (`idproduct`) REFERENCES `products` (`idproduct`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of imp_products
-- ----------------------------
INSERT INTO `imp_products` VALUES (1, 1, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, '', 31, 0, 0, 0, 3, '2019-08-29 15:26:05', '2019-08-29 21:35:16');
INSERT INTO `imp_products` VALUES (2, 2, 0, 2, 0, NULL, 3000000, 3000000, 0, NULL, 1800000, 10, '', 31, 0, 0, 0, 3, '2019-08-29 15:29:34', '2019-08-29 21:41:53');
INSERT INTO `imp_products` VALUES (3, 4, 0, 2, NULL, NULL, 4000000, 4000000, NULL, NULL, 2400000, 15, '', 31, 0, 0, 0, 3, '2019-08-29 21:56:45', '2019-08-29 22:14:41');
INSERT INTO `imp_products` VALUES (4, 5, 0, 2, NULL, NULL, 15000000, 15000000, NULL, NULL, 9600000, 5, '', 31, 0, 0, 0, 3, '2019-08-30 08:53:07', '2019-08-30 08:53:43');
INSERT INTO `imp_products` VALUES (5, 6, 0, 2, NULL, NULL, 2000000, 2000000, 2000000, 24, NULL, NULL, '', 31, 0, 0, 0, 3, '2019-08-30 09:22:06', '2019-08-30 09:41:50');
INSERT INTO `imp_products` VALUES (6, 7, 0, 2, NULL, NULL, 800000, 800000, 800000, 72, NULL, NULL, '', 31, 0, 0, 0, 3, '2019-08-30 09:27:42', '2019-08-30 09:27:42');
INSERT INTO `imp_products` VALUES (7, 8, 0, 2, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '', 31, 0, 0, 0, 3, '2019-08-31 15:18:08', '2019-08-31 15:18:08');
INSERT INTO `imp_products` VALUES (8, 9, 0, 2, NULL, NULL, 800000, 800000, NULL, NULL, 480000, 10, '', 31, 0, 0, 0, 3, '2019-08-31 15:20:25', '2019-08-31 15:20:25');
INSERT INTO `imp_products` VALUES (9, 10, 0, 2, NULL, NULL, 400000, 4000000, NULL, NULL, 2400000, 10, '', 31, 0, 0, 0, 3, '2019-08-31 15:22:37', '2019-08-31 15:22:37');
INSERT INTO `imp_products` VALUES (10, 11, 0, 2, NULL, NULL, 10000000, 10000000, NULL, NULL, 6000000, 5, '', 31, 0, 0, 0, 3, '2019-08-31 15:24:43', '2019-08-31 15:24:43');
INSERT INTO `imp_products` VALUES (11, 12, 0, 2, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '', 31, 0, 0, 0, 3, '2019-08-31 15:26:43', '2019-08-31 15:26:43');
INSERT INTO `imp_products` VALUES (12, 13, 0, 2, NULL, NULL, 4000000, 4000000, NULL, NULL, 2400000, 10, '', 31, 0, 0, 0, 3, '2019-08-31 15:28:22', '2019-08-31 15:28:22');
INSERT INTO `imp_products` VALUES (13, 14, 0, 2, NULL, NULL, 15000000, 15000000, NULL, NULL, 9000000, 5, '', 31, 0, 0, 0, 3, '2019-08-31 15:30:10', '2019-08-31 15:30:10');
INSERT INTO `imp_products` VALUES (14, 15, 0, 2, NULL, 0, 0, 0, NULL, NULL, 0, NULL, '', 31, 0, 0, 0, 3, '2019-08-31 15:31:24', '2019-08-31 15:31:24');
INSERT INTO `imp_products` VALUES (15, 16, 0, 2, NULL, NULL, 3000000, 3000000, NULL, NULL, 1800000, 10, '', 31, 0, 0, 0, 3, '2019-08-31 15:32:57', '2019-08-31 15:32:57');
INSERT INTO `imp_products` VALUES (16, 17, 0, 2, NULL, NULL, 10000000, 10000000, NULL, NULL, 6000000, 5, '', 31, 0, 0, 0, 3, '2019-08-31 15:34:25', '2019-08-31 15:34:25');
...
CREATE TABLE `products`  (
  ...
  `idcrosstype` int(10) UNSIGNED NULL DEFAULT NULL,
  `idparent` bigint(20) NULL DEFAULT NULL,
  `idstatus_type` int(10) NULL DEFAULT NULL,
  `created_at` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`idproduct`) USING BTREE,
  INDEX `fr_product_crosstype`(`idcrosstype`) USING BTREE,
  CONSTRAINT `fr_product_crosstype` FOREIGN KEY (`idcrosstype`) REFERENCES `cross_type` (`idcrosstype`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Compact;
...
BEGIN
                DECLARE _idcattype int;
								...
								INSERT INTO imp_products(idproduct, idcustomer, iduser, amount, price_import, price, price_sale_origin, price_combo, quality_combo, price_gift, quality_gift, note, idstore, axis_x, axis_y, axis_z,id_status_type) VALUES ( _idproduct, _idcustomer, _iduser, _amount, _price_import, _price, _price_sale_origin, _price_combo, _quality_combo, _price_gift, _quality_gift, _note, _idstore, _axis_x, _axis_y, _axis_z,_id_status_type);             
            END
;;
delimiter ;
