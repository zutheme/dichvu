...
INSERT INTO `menu_has_cate` VALUES (142, 1, 24, 0, 0, 3, 0, '2019-08-02 17:07:01', '2019-11-12 16:11:42');
INSERT INTO `menu_has_cate` VALUES (145, 1, 29, 0, 0, 4, 0, '2019-08-02 17:08:56', '2019-11-12 16:11:42');
INSERT INTO `menu_has_cate` VALUES (146, 1, 6, 0, 0, 0, 0, '2019-08-02 17:08:56', '2019-08-03 10:01:20');
INSERT INTO `menu_has_cate` VALUES (147, 1, 33, 145, 1, 5, 0, '2019-11-12 15:39:25', '2019-11-12 16:11:42');
...
INSERT INTO `permissions` VALUES (2, 'list-product', 'Xem sản phẩm trong danh mục trị nám tàn nhang', 1, 6, NULL, NULL, NULL);
...
BEGIN             
SELECT p.idperm, p.`name`, p.description, pc.command, c.namecat FROM `permissions` as p LEFT JOIN perm_commands as pc on p.idpermcommand = pc.idpercommand LEFT JOIN categories as c on p.idcatogory = c.idcategory;
END
;;
delimiter ;
