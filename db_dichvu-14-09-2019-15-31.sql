...
INSERT INTO `imp_products` VALUES (2, 2, 0, 2, 1, 1, 0, 0, 1500000, 3000000, 5, 0, NULL, 1800000, 10, '', 31, 0, 0, 0, 4, NULL, NULL, '2019-08-29 15:29:34', '2019-09-13 11:18:28');
INSERT INTO `imp_products` VALUES (3, 4, 0, 2, 1, 1, NULL, NULL, 2400000, 2400000, 15, NULL, NULL, 2400000, 15, '', 31, 0, 0, 0, 4, NULL, NULL, '2019-08-29 21:56:45', '2019-09-13 15:11:09');
INSERT INTO `imp_products` VALUES (4, 5, 0, 2, 1, 1, 0, 0, 5000000, 15000000, 5, NULL, NULL, 9600000, 5, '', 31, 0, 0, 0, 4, NULL, NULL, '2019-08-30 08:53:07', '2019-09-13 15:11:52');
INSERT INTO `imp_products` VALUES (5, 6, 0, 2, 2, 1, NULL, NULL, 2000000, 2000000, 24, 2000000, 24, NULL, NULL, '', 31, 0, 0, 0, 4, NULL, NULL, '2019-08-30 09:22:06', '2019-09-13 10:57:36');
INSERT INTO `imp_products` VALUES (6, 7, 0, 2, 2, 1, NULL, NULL, 800000, 800000, 72, 800000, 72, NULL, NULL, '', 31, 0, 0, 0, 4, NULL, NULL, '2019-08-30 09:27:42', '2019-09-13 10:57:36');
...
INSERT INTO `imp_products` VALUES (62, 21, 0, 2, 2, 1, 0, 0, 100000, 0, 5, NULL, NULL, NULL, NULL, NULL, 11, 0, 0, 0, 4, NULL, NULL, '2019-09-13 17:24:42', '2019-09-13 17:27:50');
...
INSERT INTO `imp_products` VALUES (69, 1, 0, 2, 4, 1, 0, 0, 110000, 0, 0, NULL, NULL, NULL, NULL, NULL, 31, 0, 0, 0, 4, '2019-09-14 00:00:00', '2019-09-14 23:59:59', '2019-09-14 11:37:18', '2019-09-14 14:18:23');
...
) ENGINE = InnoDB AUTO_INCREMENT = 175 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Compact;
...
BEGIN
                DECLARE _idcattype int;
								...
								INSERT INTO imp_products(idproduct, idcustomer, iduser, idcrosstype, idparentcross, amount, price_import, price, price_sale_origin, quality_sale, note, idstore, axis_x, axis_y, axis_z,id_status_type) VALUES ( _idproduct, _idcustomer, _iduser, _idcrosstype, _idparentcross, _amount, _price_import, _price, _price_sale_origin, _quality_sale, _note, _idstore, _axis_x, _axis_y, _axis_z,_id_status_type);             
            END
;;
delimiter ;
...
BEGIN
                ...
                create TEMPORARY TABLE tmp_import(idtmp INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY , idimp INTEGER not NULL, idcrosstype INTEGER not NULL, price INTEGER not NULL, quality_sale  INTEGER not NULL, id_status_type  INTEGER not NULL, fromdate TIMESTAMP NULL, todate TIMESTAMP NULL);
                SET @queryString = _str_query;
                PREPARE stmt FROM @queryString;
                EXECUTE stmt;
                DEALLOCATE PREPARE stmt;
