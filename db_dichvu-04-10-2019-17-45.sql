...
) ENGINE = InnoDB AUTO_INCREMENT = 275 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Compact;
...
INSERT INTO `exp_products` VALUES (262, 50, 0, 14, 1, 0, 0, 0, 2, 1, 15000000, '', 11, 0, 0, 0, 1, '2019-10-03 15:26:50', '2019-10-03 15:26:50');
INSERT INTO `exp_products` VALUES (263, 50, 4, 31, 2, 0, 0, 0, 2, 1, 2400000, '', 11, 0, 0, 0, 1, '2019-10-03 15:26:50', '2019-10-03 15:26:50');
INSERT INTO `exp_products` VALUES (264, 50, 4, 31, 2, 0, 0, 0, 2, 1, 1500000, '', 11, 0, 0, 0, 1, '2019-10-03 15:26:50', '2019-10-03 15:26:50');
INSERT INTO `exp_products` VALUES (265, 50, 0, 27, 3, 0, 0, 0, 2, 1, 4000000, '', 11, 0, 0, 0, 1, '2019-10-03 15:26:50', '2019-10-03 15:26:50');
INSERT INTO `exp_products` VALUES (266, 50, 1, 2, 4, 3, 0, 0, 2, 10, 100000, '', 11, 0, 0, 0, 1, '2019-10-03 15:26:50', '2019-10-03 15:26:50');
INSERT INTO `exp_products` VALUES (269, 51, 4, 31, 1, 0, 0, 0, 2, 1, 2400000, '', 11, 0, 0, 0, 1, '2019-10-03 15:34:25', '2019-10-03 15:34:25');
INSERT INTO `exp_products` VALUES (270, 51, 4, 31, 1, 0, 0, 0, 2, 1, 1500000, '', 11, 0, 0, 0, 1, '2019-10-03 15:34:25', '2019-10-03 15:34:25');
INSERT INTO `exp_products` VALUES (271, 51, 0, 20, 2, 0, 0, 0, 2, 1, 0, '', 11, 0, 0, 0, 1, '2019-10-03 15:34:25', '2019-10-03 15:34:25');
INSERT INTO `exp_products` VALUES (272, 51, 1, 21, 3, 2, 0, 0, 2, 5, 10000000, '', 11, 0, 0, 0, 1, '2019-10-03 15:34:25', '2019-10-03 15:34:25');
INSERT INTO `exp_products` VALUES (273, 51, 2, 22, 4, 2, 0, 0, 2, 10, 9000000, '', 11, 0, 0, 0, 1, '2019-10-03 15:34:25', '2019-10-03 15:34:25');
INSERT INTO `exp_products` VALUES (274, 51, 2, 2, 5, 2, 0, 0, 2, 9, 1000000, '', 11, 0, 0, 0, 1, '2019-10-03 15:34:25', '2019-10-03 15:34:25');
...
BEGIN
                ...
                create TEMPORARY TABLE temp_product2(idtmp INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY , idorder INTEGER not NULL, idcrosstype INTEGER not NULL,parent  INTEGER not NULL, idparentcross INTEGER NULL,input_quality  INTEGER not NULL,idproduct  INTEGER not NULL,inp_session  INTEGER not NULL,trash  INTEGER not NULL) as (SELECT * from tmp_product1);
                    ...
                    /*INSERT into exp_products(idnumberorder, idcrosstype, idproduct,idorder, parentidorder, idcustomer, idrecipent, iduser, amount, price, note, idstore, axis_x, axis_y, axis_z, id_status_type) */
										...
										SELECT info.* from (SELECT info1.*, imp1.price FROM (SELECT tmp1.*, MAX(imp1.idimp) as max_idimp_price FROM tmp_product1 as tmp1 LEFT JOIN imp_products as imp1 on tmp1.idproduct = imp1.idproduct WHERE tmp1.idcrosstype = imp1.idcrosstype AND tmp1.idparentcross = imp1.idparentcross GROUP BY tmp1.idorder) as info1 LEFT JOIN imp_products as imp1 on info1.max_idimp_price = imp1.idimp) as info;
										/*SELECT info1.*, MAX(info1.idimp) as max_idimp_price FROM (SELECT tmp1.*, imp1.idimp FROM tmp_product1 as tmp1 LEFT JOIN imp_products as imp1 on tmp1.idproduct = imp1.idproduct WHERE imp1.idstore = _fromidstore and imp1.id_status_type = 4 and imp1.idimp is not NULL and tmp1.idcrosstype = imp1.idcrosstype AND tmp1.idparentcross = imp1.idparentcross) as info1 GROUP BY info1.idorder; */			
